...
def evaluar_arquitectura(ecosistema_principal, desglose):
    """
    Evalúa las proporciones del proyecto para aplicar el multiplicador de riesgo
    y generar el contexto de amenaza dinámico.
    """
    ...
    # 1. Lógica de Riesgo Combinado (Ej. Full-Stack)
    ...
    # 2. Lógica para proyectos predominantemente Python
    ...
    # 3. Lógica para proyectos predominantemente JS/NPM
    ...
    # 4. Fallback: Multiplicador estándar
    else:
    ...
    # Devolvemos el porcentaje exacto para que el Frontend dibuje el gráfico
    return {
...
def calcular_nivel(score):
    """Asigna una etiqueta visual según el puntaje final."""
    if score == 0: return "SEGURO"
    elif score <= 15: return "BAJO"
    elif score <= 40: return "MEDIO"
    elif score <= 90: return "ALTO"
    return "CRITICO"
...
def realizar_analisis_contextual():
    ...
    for repo in data:
        ...
        # NUEVO: Leemos los datos completos del JSON anidado
        ...
        # 1. Calculamos el Daño (Puntaje Base)
        score_base = (
        ...
        # 2. Evaluamos la Arquitectura (El Terreno)
        ...
        # Guardamos la estructura lista para Chart.js
        analisis_repositorios.append({
            "repository": repo_name,
            "architecture_context": {
                "primary_ecosystem": eco_principal,
                "stack_breakdown": analisis_arq["breakdown"],  # <--- Esto alimenta tu nuevo gráfico de barras apiladas al 100%
